              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-sm fonts-semibold md:text-base">{invoice.name}</p>
                    <p className="hidden text-sm text-gray-500 sm:block">{invoice.email}</p>
                  </div>
                </div>
                <p className={`${lusitana.className} truncate text-sm fonts-medium md:text-base`}>{invoice.amount}</p>
              </div>
            );
          })}
        </div>
